...
@Setter
@Log4j2
public class TplCanceledConsultationByDoctor extends ATemplate {

  final String htmlFile = "cancelled_consultation_by_doctor.html";
  final ETemplateTypes type = ETemplateTypes.CANCEL_CONSULTATION_DOCTOR;
  ...
  public TplCanceledConsultationByDoctor() {
