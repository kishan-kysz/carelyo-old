...
import { IBloodPressure } from '../../api/types';
import useProfile from '../../hooks/use-profile';

const BloodPressure = ({ data }: { data: IBloodPressure[] }) => {
								...
								>
									<div>
										<NumberInput
											...
											min={0}
											max={250}
											placeholder={user?.polygenic.diastolic}
									...
									<div>
										<Select
											...
											mb={'sm'}
											defaultValue={user?.polygenic.posture}
											label={
												<>
													<Text mb={5}>{t('tr.posture')}</Text>
												</>
