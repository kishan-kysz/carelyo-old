...
import { IBloodOxygen, IChildrenResponse } from '../../api/types';
import useChildVitals from '../../hooks/use-child-vitals';

const ChildBloodOxgen = ({ child, data }: { child: IChildrenResponse, data: IBloodOxygen[] }) => {
...
export default ChildBloodOxgen;
