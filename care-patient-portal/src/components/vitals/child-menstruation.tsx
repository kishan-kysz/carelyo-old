...
import { IChildrenResponse, IMenstruation } from '../../api/types';
import useChildVitals from '../../hooks/use-child-vitals';

const ChildMenstruation = ({ child, data }: { child: IChildrenResponse, data: IMenstruation[] }) => {
...
export default ChildMenstruation;
