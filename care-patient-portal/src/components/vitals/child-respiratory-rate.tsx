...
import { IChildrenResponse, IRespiratoryRate } from '../../api/types';
import useProfile from '../../hooks/use-profile';
import useChildVitals from '../../hooks/use-child-vitals';

const ChildRespiratoryRate = ({ child, data }: { child: IChildrenResponse, data: IRespiratoryRate[] }) => {
								...
								>
									<div>
										<NumberInput
											...
											min={0}
											max={130}
											defaultValue={child?.polygenic.pulse}
...
export default ChildRespiratoryRate;
