...
import { IBodyTemperature, IChildrenResponse } from '../../api/types';
import useChildVitals from '../../hooks/use-child-vitals';

const ChildTemperature = ({ child, data }: { child: IChildrenResponse, data: IBodyTemperature[] }) => {
...
export default ChildTemperature;
