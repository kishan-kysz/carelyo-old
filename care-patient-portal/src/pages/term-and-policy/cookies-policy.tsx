...
import '../../assets/styles/pages/cookiesPolicyStyles.css';
...
export const CookiesPolicy = () => {
	...
	return (
		<div className="container">
			<h1>Cookie Policy for carelyo</h1>

			<p>
				This is the Cookie Policy for carelyo, accessible from
				https://carelyo.com
			</p>
			...
			<ul>
				...
				<li>
					<p>
						...
						<strong>Placeholder for social networks list</strong>, will set
			...
			<ul>
				<li>Email: cookies@carelyo.com</li>
			</ul>
